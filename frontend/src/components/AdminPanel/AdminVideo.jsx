                        ...
                        <td className="text-center">
                          ...
                          >
                            <NavLink 
                              ...
                              className="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-500 hover:to-indigo-600 text-blue-100 py-2 px-4 rounded-lg font-medium flex items-center justify-center"
                            >
