      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Search and update existing coding problems
          </p>
        </motion.div>
        ...
        >
          <div className="relative">
            <input
              ...
              className="w-full py-3 px-6 bg-gray-800/50 border border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-gray-200 placeholder-gray-500"
              value={searchTerm}
                        ...
                        <td className="text-center">
                          ...
                          >
                            <NavLink 
                              ...
                              className="bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-500 hover:to-emerald-600 text-green-100 py-2 px-4 rounded-lg font-medium flex items-center justify-center"
                            >
