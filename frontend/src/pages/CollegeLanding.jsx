      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Empower your institution with comprehensive coding education
            management. Track progress, assign challenges, and build the next
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <NavLink
              to="https://res.cloudinary.com/dltqzdtfh/video/upload/v1753589274/collegefeatures_j1vcfq.mp4"
              target="_blank"
              rel="noopener noreferrer"
              className="border-2 border-orange-500 text-orange-500 font-semibold py-4 px-8 rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300 flex items-center gap-2 justify-center"
            >
              <FaCode />
              Watch Demo
            </NavLink>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
            ...
            <p className="text-gray-300 mb-6">
              Organize students batch-wise, track individual progress, and
              manage coding assignments seamlessly.
            </p>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
            ...
            <p className="text-gray-300 mb-6">
              Assign level-appropriate Data Structures & Algorithms problems
              daily to keep students engaged and learning.
            </p>
            <ul className="text-gray-400 space-y-2">
              <li className="flex items-center gap-2">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
            ...
            <p className="text-gray-300 mb-6">
              Comprehensive dashboard with detailed insights into student
              performance and coding progress.
            </p>
            <ul className="text-gray-400 space-y-2">
              <li className="flex items-center gap-2">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
            ...
            <p className="text-gray-300 mb-6">
              Streamline placement activities by easily sharing top-performing
              student profiles with companies.
            </p>
            <ul className="text-gray-400 space-y-2">
              <li className="flex items-center gap-2">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
            ...
            <p className="text-gray-300 mb-6">
              Monitor student activities and assignment submissions in real-time
              for immediate feedback and support.
            </p>
            <ul className="text-gray-400 space-y-2">
              <li className="flex items-center gap-2">
                <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
            ...
            <p className="text-gray-300 mb-6">
              Identify and showcase your best-performing students with
        ...
        <div className="mb-20">
          <h2 className="text-4xl font-bold text-center text-white mb-16">
            How IndieCode <span className="text-orange-400">Transforms</span>{" "}
            Your College
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Organize your students into batches and set up coding
                assignments tailored to their skill levels.
              </p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-gray-300">
                Track student progress in real-time and analyze their coding
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Leverage top student profiles to attract companies and boost
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-12 mb-20">
          <h2 className="text-4xl font-bold text-center text-white mb-12">
            Why Choose <span className="text-orange-400">IndieCode</span> for
            Your College?
          </h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Structured daily challenges ensure consistent skill
                    development and better coding proficiency.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Showcase top talent to companies with detailed performance
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Automate assignment distribution and progress tracking to
                    save valuable time.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Keep students motivated with gamified challenges and
                    recognition systems.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Build a stronger reputation with improved coding culture and
        ...
        <div className="text-center bg-gradient-to-r from-orange-500/20 to-orange-600/20 border border-orange-500/30 rounded-3xl p-12">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join the revolution in coding education. Contact our support team to
            get your college login credentials and start building excellence
            today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <NavLink
